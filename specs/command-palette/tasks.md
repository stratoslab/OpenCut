...
- [x] **Task 1: Create CommandRegistry**
...
- [x] **Task 3: Build CommandPalette UI**
...
- [x] **Task 4: Add Keyboard Navigation**
...
- [x] **Task 5: Write property-based tests**
