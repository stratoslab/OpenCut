...
- [x] **Task 1: Create FillerDetector**
...
- [x] **Task 2: Create SilenceDetector**
...
- [x] **Task 5: Implement Timeline Editing**
...
- [x] **Task 6: Write property-based tests**
