...
export function Onboarding() {
	...
	const getStepTitle = () => {
		switch (step) {
			case 0:
				return "Welcome to StratosCut Beta! 🎉";
			case 1:
				return "⚠️ This is a super early beta!";
			case 2:
				return "🦋 Have fun testing!";
			default:
				return "StratosCut Onboarding";
		}
	};
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to StratosCut Beta! 🎉" />
							<Description description="You're among the first to try StratosCut - the fully open source CapCut alternative." />
						</div>
